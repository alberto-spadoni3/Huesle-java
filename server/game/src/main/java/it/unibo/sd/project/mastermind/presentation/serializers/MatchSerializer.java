...
public class MatchSerializer extends AbstractJsonSerializer<Match> {
    ...
    protected JsonElement toJsonElement(Match match) {
        ...
        jsonMatch.add("matchStatus",
            Presentation.serializerOf(MatchStatus.class).getJsonElement(match.getMatchStatus()));
        ...
        JsonArray jsonSecretCode = (JsonArray) Presentation.serializerOf(SecretCode.class)
            .getJsonElement(match.getSecretCode());
